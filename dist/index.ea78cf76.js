...
var _reservationForm = require("./ReservationForm");
var _reservationFormDefault = parcelHelpers.interopDefault(_reservationForm);
const imageWelcome_1 = require("../assets/welcome1.png");
const imageWelcome_2 = require("../assets/welcome2.jpeg");
function Home() {
    const section = document.createElement('section');
    section.innerHTML += _reservationFormDefault.default();
    section.innerHTML += `
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","./Slider":"kYWLE","./ReservationForm":"cj43a","../assets/welcome1.png":"lX8pB","../assets/welcome2.jpeg":"1vL0x"}],"gkKU3":[function(require,module,exports) {
...
},{"./helpers/bundle-url":"lgJ39"}],"cj43a":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"lX8pB":[function(require,module,exports) {
module.exports = require('./helpers/bundle-url').getBundleURL('dI6RG') + "welcome1.5d4b38a1.png" + "?" + Date.now();

},{"./helpers/bundle-url":"lgJ39"}],"1vL0x":[function(require,module,exports) {
module.exports = require('./helpers/bundle-url').getBundleURL('dI6RG') + "welcome2.7b318f6d.jpeg" + "?" + Date.now();
